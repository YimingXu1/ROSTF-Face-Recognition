...
#include "Ros_Tensorflow/MsgTutorial.h"// MsgTutorial消息头文件（ 构建后自动生成）
...
nh.advertise<Ros_Tensorflow::MsgTutorial>("ros_tutorial_msg", 100);
 // 设定循环周期。"10"是指10Hz，是以0.1秒间隔重复
 ros::Rate loop_rate(10);
 Ros_Tensorflow::MsgTutorial msg; // 以MsgTutorial消息文件格式声明一个叫做msg的消息
